...
<body>
    ...
    <script>
        ...
        function extractDude() {
            ...
            if (dom.querySelector('input#pname')) {
            ...
            if (dom.querySelector('input[name=sex]')) {
            ...
            // * Age: value => input#Age
            if (dom.querySelector('input#Age')) {
            ...
            if (dom.querySelector('input[name=dent_code]')) {
            ...
            if (dom.querySelector('input[name=dent_pos]')) {
            ...
            if (dom.querySelector('input[name=dent_name]')) {
            ...
            if (dom.querySelector('input[name=dent_sure]')) {
            ...
            if (dom.querySelector('input[name=Admit_Date]')) {
            ...
            if (dom.querySelector('input#DR')) {
                // console.log('DM complication DR');
            } else {
                console.log('ERROR : DM complication DR')
            }
